/* 场景数据存储 — 三页共享。localStorage 持久化，含默认演示场景、YAML 序列化、校验。 */
(function () {
  ...
  function defaultScenario() {
    return {
      ...
      satellites: [
        sat("SAT-01", "侦察-01", "观测星组", "光学成像", 6878, 0.0011, 97.5, 60, 90, 0, 86, 1240),
        sat("SAT-02", "侦察-02", "观测星组", "光学成像", 6878, 0.0011, 97.5, 60, 90, 40, 82, 1240),
        sat("SAT-03", "侦察-03", "观测星组", "合成孔径雷达", 6928, 0.0015, 97.8, 100, 90, 0, 78, 1560),
        sat("SAT-04", "中继-01", "通信中继组", "通信中继", 12760, 0.0008, 28.5, 30, 0, 0, 93, 2100),
        sat("SAT-05", "中继-02", "通信中继组", "通信中继", 12760, 0.0008, 28.5, 150, 0, 120, 91, 2100),
        sat("SAT-06", "机动试验星", "试验星组", "电子侦察", 7178, 0.0210, 45.0, 200, 30, 0, 64, 980),
        sat("TGT-01", "目标-01", "非合作目标", "未知", 7078, 0.0030, 53.0, 210, 60, 25, 50, 800),
        sat("TGT-02", "目标-02", "非合作目标", "未知", 7278, 0.0150, 63.4, 250, 270, 80, 50, 800)
      ],
      groundStations: [
  ...
  function sat(id, name, group, payload, a, e, i, raan, argp, M0, fuel, mass) {
    return {
